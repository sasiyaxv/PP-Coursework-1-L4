...
def histogram():  # Histogram
    ...
    for x in range(find_max_count()):

        if x < progress_counter:
            print("   *", end="        ")
        else:
            print(" ", end="        ")
        if x < trailer_counter:
            print("*", end="        ")
        else:
            print(" ", end="        ")
        if x < retriever_counter:
            print("*", end="        ")
        else:
            print(" ", end="        ")
        if x < exclude_counter:
            print("*")
        else:
            print(" ")
...
def find_max_count():
    all_counters=[progress_counter,exclude_counter,trailer_counter,retriever_counter]
    maximum_count = max(all_counters)
